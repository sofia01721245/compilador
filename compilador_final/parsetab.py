...
_lr_productions = [
  ...
  ('parametros_opt -> parametros','parametros_opt',1,'p_parametros_opt','parser_rules.py',72),
  ('parametros_opt -> empty','parametros_opt',1,'p_parametros_opt','parser_rules.py',73),
  ('parametros -> ID COLON type param_list','parametros',4,'p_parametros','parser_rules.py',77),
  ('param_list -> COMMA ID COLON type param_list','param_list',5,'p_param_list','parser_rules.py',81),
  ('param_list -> empty','param_list',1,'p_param_list','parser_rules.py',82),
  ('body -> LBRACE statement_list RBRACE','body',3,'p_body','parser_rules.py',89),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','parser_rules.py',93),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parser_rules.py',94),
  ('statement -> assign','statement',1,'p_statement','parser_rules.py',101),
  ('statement -> condition','statement',1,'p_statement','parser_rules.py',102),
  ('statement -> cycle','statement',1,'p_statement','parser_rules.py',103),
  ('statement -> f_call','statement',1,'p_statement','parser_rules.py',104),
  ('statement -> print','statement',1,'p_statement','parser_rules.py',105),
  ('assign -> ID ASSIGN_SIGN expresion SEMICOLON','assign',4,'p_assign','parser_rules.py',109),
  ('print -> KEYWORD_PRINT LPAREN print_items RPAREN SEMICOLON','print',5,'p_print','parser_rules.py',135),
  ('print_items -> print_items COMMA print_item','print_items',3,'p_print_items','parser_rules.py',139),
  ('print_items -> print_item','print_items',1,'p_print_items','parser_rules.py',140),
  ('print_item -> expresion','print_item',1,'p_print_item','parser_rules.py',147),
  ('print_item -> CTE_STRING','print_item',1,'p_print_item','parser_rules.py',148),
  ('cycle -> KEYWORD_DO body KEYWORD_WHILE LPAREN expresion RPAREN SEMICOLON','cycle',7,'p_cycle','parser_rules.py',155),
  ('condition -> KEYWORD_IF LPAREN expresion RPAREN cuadr_if body else_arg SEMICOLON','condition',8,'p_condition','parser_rules.py',176),
  ('cuadr_if -> <empty>','cuadr_if',0,'p_cuadr_if','parser_rules.py',189),
  ('else_arg -> KEYWORD_ELSE cuadr_else body','else_arg',3,'p_else_arg','parser_rules.py',199),
  ('cuadr_else -> <empty>','cuadr_else',0,'p_cuadr_else','parser_rules.py',203),
  ('else_arg -> empty','else_arg',1,'p_else_arg_empty','parser_rules.py',222),
  ('f_call -> ID LPAREN expresion_list_opt RPAREN SEMICOLON','f_call',5,'p_f_call','parser_rules.py',234),
  ('expresion_list_opt -> expresion_list','expresion_list_opt',1,'p_expresion_list_opt','parser_rules.py',265),
  ('expresion_list_opt -> empty','expresion_list_opt',1,'p_expresion_list_opt','parser_rules.py',266),
  ('expresion_list -> expresion_list COMMA expresion','expresion_list',3,'p_expresion_list','parser_rules.py',270),
  ('expresion_list -> expresion','expresion_list',1,'p_expresion_list','parser_rules.py',271),
  ('expresion -> exp comparador exp','expresion',3,'p_expresion','parser_rules.py',278),
  ('expresion -> exp','expresion',1,'p_expresion','parser_rules.py',279),
  ('comparador -> LESS','comparador',1,'p_comparador','parser_rules.py',307),
  ('comparador -> GREATER','comparador',1,'p_comparador','parser_rules.py',308),
  ('comparador -> NOT_EQUAL','comparador',1,'p_comparador','parser_rules.py',309),
  ('comparador -> EQUAL','comparador',1,'p_comparador','parser_rules.py',310),
  ('comparador -> GREATER_EQUAL','comparador',1,'p_comparador','parser_rules.py',311),
  ('comparador -> LESS_EQUAL','comparador',1,'p_comparador','parser_rules.py',312),
  ('exp -> exp OP_SUM termino','exp',3,'p_exp','parser_rules.py',316),
  ('exp -> exp OP_SUB termino','exp',3,'p_exp','parser_rules.py',317),
  ('exp -> termino','exp',1,'p_exp','parser_rules.py',318),
  ('termino -> termino OP_MUL factor','termino',3,'p_termino','parser_rules.py',345),
  ('termino -> termino OP_DIV factor','termino',3,'p_termino','parser_rules.py',346),
  ('termino -> factor','termino',1,'p_termino','parser_rules.py',347),
  ('factor -> LPAREN expresion RPAREN','factor',3,'p_factor','parser_rules.py',375),
  ('factor -> OP_SUM varcte','factor',2,'p_factor','parser_rules.py',376),
  ('factor -> OP_SUB varcte','factor',2,'p_factor','parser_rules.py',377),
  ('factor -> varcte','factor',1,'p_factor','parser_rules.py',378),
  ('varcte -> ID','varcte',1,'p_varcte','parser_rules.py',387),
  ('varcte -> CTE_INT','varcte',1,'p_varcte','parser_rules.py',388),
  ('varcte -> CTE_FLOAT','varcte',1,'p_varcte','parser_rules.py',389),
  ('empty -> <empty>','empty',0,'p_empty','parser_rules.py',412),
]
