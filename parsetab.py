...
_lr_productions = [
  ...
  ('main_marker -> KEYWORD_MAIN','main_marker',1,'p_main_marker','parser_rules.py',24),
  ('vars_opt -> var_block','vars_opt',1,'p_vars_opt','parser_rules.py',30),
  ('vars_opt -> empty','vars_opt',1,'p_vars_opt','parser_rules.py',31),
  ('var_block -> KEYWORD_VAR var_lines','var_block',2,'p_var_block','parser_rules.py',38),
  ('var_lines -> var_lines var_list SEMICOLON','var_lines',3,'p_var_lines','parser_rules.py',70),
  ('var_lines -> var_list SEMICOLON','var_lines',2,'p_var_lines','parser_rules.py',71),
  ('var_list -> ID id_list COLON type','var_list',4,'p_var_list','parser_rules.py',78),
  ('id_list -> COMMA ID id_list','id_list',3,'p_id_list','parser_rules.py',83),
  ('id_list -> empty','id_list',1,'p_id_list','parser_rules.py',84),
  ('type -> KEYWORD_INT','type',1,'p_type','parser_rules.py',91),
  ('type -> KEYWORD_FLOAT','type',1,'p_type','parser_rules.py',92),
  ('type -> KEYWORD_STRING','type',1,'p_type','parser_rules.py',93),
  ('funcs_opt -> funcs_opt FUNCS','funcs_opt',2,'p_funcs_opt','parser_rules.py',97),
  ('funcs_opt -> FUNCS','funcs_opt',1,'p_funcs_opt','parser_rules.py',98),
  ('funcs_opt -> empty','funcs_opt',1,'p_funcs_opt','parser_rules.py',99),
  ('FUNCS -> KEYWORD_VOID ID func_start LPAREN parametros_opt RPAREN LBRACKET vars_opt LBRACE body RBRACE RBRACKET func_end SEMICOLON','FUNCS',14,'p_FUNCS','parser_rules.py',108),
  ('func_start -> <empty>','func_start',0,'p_func_start','parser_rules.py',119),
  ('func_end -> <empty>','func_end',0,'p_func_end','parser_rules.py',131),
  ('parametros_opt -> parametros','parametros_opt',1,'p_parametros_opt','parser_rules.py',138),
  ('parametros_opt -> empty','parametros_opt',1,'p_parametros_opt','parser_rules.py',139),
  ('parametros -> parametros COMMA ID COLON type','parametros',5,'p_parametros','parser_rules.py',146),
  ('parametros -> ID COLON type','parametros',3,'p_parametros','parser_rules.py',147),
  ('body -> statement_list','body',1,'p_body','parser_rules.py',191),
  ('statement_list -> statement statement_list','statement_list',2,'p_statement_list','parser_rules.py',195),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parser_rules.py',196),
  ('statement_list -> empty','statement_list',1,'p_statement_list','parser_rules.py',197),
  ('statement -> assign','statement',1,'p_statement','parser_rules.py',214),
  ('statement -> condition','statement',1,'p_statement','parser_rules.py',215),
  ('statement -> cycle','statement',1,'p_statement','parser_rules.py',216),
  ('statement -> f_call','statement',1,'p_statement','parser_rules.py',217),
  ('statement -> print','statement',1,'p_statement','parser_rules.py',218),
  ('assign -> ID ASSIGN_SIGN expresion SEMICOLON','assign',4,'p_assign','parser_rules.py',222),
  ('print -> KEYWORD_PRINT LPAREN print_items RPAREN SEMICOLON','print',5,'p_print','parser_rules.py',251),
  ('print_items -> print_items COMMA print_item','print_items',3,'p_print_items','parser_rules.py',288),
  ('print_items -> print_item','print_items',1,'p_print_items','parser_rules.py',289),
  ('print_item -> expresion','print_item',1,'p_print_item','parser_rules.py',296),
  ('print_item -> varcte','print_item',1,'p_print_item','parser_rules.py',297),
  ('cycle -> KEYWORD_DO cuadr_do LBRACE body RBRACE KEYWORD_WHILE LPAREN expresion RPAREN SEMICOLON','cycle',10,'p_cycle','parser_rules.py',304),
  ('cuadr_do -> <empty>','cuadr_do',0,'p_cuadr_do','parser_rules.py',331),
  ('condition -> KEYWORD_IF LPAREN expresion RPAREN cuadr_if LBRACE body RBRACE else_arg SEMICOLON','condition',10,'p_condition','parser_rules.py',335),
  ...
  ('else_arg -> empty','else_arg',1,'p_else_arg_empty','parser_rules.py',379),
  ('f_call -> ID LPAREN expresion_list_opt RPAREN SEMICOLON','f_call',5,'p_f_call_simple','parser_rules.py',387),
  ('expresion_list_opt -> expresion_list','expresion_list_opt',1,'p_expresion_list_opt','parser_rules.py',444),
  ('expresion_list_opt -> empty','expresion_list_opt',1,'p_expresion_list_opt','parser_rules.py',445),
  ('expresion_list -> expresion_list COMMA expresion','expresion_list',3,'p_expresion_list','parser_rules.py',449),
  ('expresion_list -> expresion','expresion_list',1,'p_expresion_list','parser_rules.py',450),
  ('expresion -> exp comparador exp','expresion',3,'p_expresion','parser_rules.py',460),
  ('expresion -> exp','expresion',1,'p_expresion','parser_rules.py',461),
  ('comparador -> LESS','comparador',1,'p_comparador','parser_rules.py',492),
  ('comparador -> GREATER','comparador',1,'p_comparador','parser_rules.py',493),
  ('comparador -> NOT_EQUAL','comparador',1,'p_comparador','parser_rules.py',494),
  ('comparador -> EQUAL','comparador',1,'p_comparador','parser_rules.py',495),
  ('comparador -> GREATER_EQUAL','comparador',1,'p_comparador','parser_rules.py',496),
  ('comparador -> LESS_EQUAL','comparador',1,'p_comparador','parser_rules.py',497),
  ('exp -> exp OP_SUM termino','exp',3,'p_exp','parser_rules.py',501),
  ('exp -> exp OP_SUB termino','exp',3,'p_exp','parser_rules.py',502),
  ('exp -> termino','exp',1,'p_exp','parser_rules.py',503),
  ('termino -> termino OP_MUL factor','termino',3,'p_termino','parser_rules.py',537),
  ('termino -> termino OP_DIV factor','termino',3,'p_termino','parser_rules.py',538),
  ('termino -> factor','termino',1,'p_termino','parser_rules.py',539),
  ('factor -> LPAREN expresion RPAREN','factor',3,'p_factor','parser_rules.py',573),
  ('factor -> OP_SUM varcte','factor',2,'p_factor','parser_rules.py',574),
  ('factor -> OP_SUB varcte','factor',2,'p_factor','parser_rules.py',575),
  ('factor -> varcte','factor',1,'p_factor','parser_rules.py',576),
  ('varcte -> ID','varcte',1,'p_varcte','parser_rules.py',601),
  ('varcte -> CTE_INT','varcte',1,'p_varcte','parser_rules.py',602),
  ('varcte -> CTE_FLOAT','varcte',1,'p_varcte','parser_rules.py',603),
  ('varcte -> CTE_STRING','varcte',1,'p_varcte','parser_rules.py',604),
  ('empty -> <empty>','empty',0,'p_empty','parser_rules.py',626),
]
